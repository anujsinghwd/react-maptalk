...
var TileConfig = function () {
  ...
  _proto._getTileNum = function _getTileNum(point, res) {
    ...
    var tileY = Math.ceil(delta + point.y / (tileSize['height'] * res));
    return {
...
var ReactMaptalk = function (_Component) {
  inherits(ReactMaptalk, _Component);

  function ReactMaptalk(props) {
    classCallCheck(this, ReactMaptalk);

    var _this = possibleConstructorReturn(this, (ReactMaptalk.__proto__ || Object.getPrototypeOf(ReactMaptalk)).call(this, props));
    ...
    var _this$props = _this.props,
        ...
        centerAroundCurrentLocation = _this$props.centerAroundCurrentLocation;
  ...
  createClass(ReactMaptalk, [{
    ...
    value: function loadMaps() {
      ...
      this.map = new Map$1(this.mapContainer, {
        center: [lon, lat],
        zoom: zoom,
    ...
    value: function renderChildren() {
      ...
      return React__default.Children.map(children, function (c) {
        return React__default.cloneElement(c, {
          map: _this6.map,
          lat: _this6.state.lat,
          lon: _this6.state.lon
        });
      });
    }
  }, {
...
evtNames.forEach(function (e) {
  return ReactMaptalk.propTypes['on' + camelize(e)] = PropTypes.func;
});
...
exports.ReactMaptalk = ReactMaptalk;
